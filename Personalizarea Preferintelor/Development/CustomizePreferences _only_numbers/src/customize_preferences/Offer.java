...
public class Offer {
    ...
    public Offer( Centroid centroid ){
        this.criteriu1 = roundValue( centroid.getVector()[0] );
        this.criteriu2 = roundValue( centroid.getVector()[1] );
        this.criteriu3 = roundValue( centroid.getVector()[2] );
        this.criteriu4 = roundValue( centroid.getVector()[3] );
        this.criteriu5 = roundValue( centroid.getVector()[4] );
        this.criteriu6 = roundValue( centroid.getVector()[5] );
        this.criteriu7 = roundValue( centroid.getVector()[6] );
        this.criteriu8 = roundValue( centroid.getVector()[7] );
    ...
    public double getCriteriu1() {
        String value = Double.toString(criteriu1);
    ...
    public double getCriteriu2() {
        String value = Double.toString(criteriu2);
    ...
    public double getCriteriu3() {
        String value = Double.toString(criteriu3);
