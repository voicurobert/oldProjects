...
public class Client {
    ...
    /**
     * Method that will compute, from the values of the criteria, a vector of type double with 5 elements. <br>
     * @return an 5 element vector of type double.
     */
    public double[] getNumericVectorValues(){
        double[] values = new double[5];
        values[0] = (double) criteriu4;
        values[1] = (double) criteriu5;
        values[2] = (double) criteriu6;
        values[3] = (double) criteriu7;
        values[4] = (double) criteriu8;
        return values;
    }
    
    /**
     * Method that will compute, from the values of the criteria, a vector of type String with 3 elements. <br>
     * @return an 3 element vector of strings.
     */
    public String[] getStringVectorValues(){
